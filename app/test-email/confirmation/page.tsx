...
import { Mail, Send, CheckCircle, AlertCircle, ShieldCheck } from 'lucide-react'
  ...
  const handleSendConfirmation = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setResult({
        ...
        message: data.message || data.error || 'Erro ao enviar email de confirmação',
      })
    } catch (error: any) {
      setResult({
        success: false,
            ...
            <GlassCard variant="light" blur="lg" className="p-8">
              <GlassCard.Header className="space-y-2 text-center">
                ...
                <GlassCard.Description className="text-white/90">
                  Envie um email de confirmação para verificar o endereço de email
                ...
                <form onSubmit={handleSendConfirmation} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-white/70">
                      Se o email não existir, um novo usuário será criado. Se já existir e não estiver confirmado, o email será reenviado.
                    </p>
                  </div>
                  ...
                  >
                    ...
                    {isLoading ? 'Enviando...' : 'Enviar Email de Confirmação'}
                  </GlassButton>
