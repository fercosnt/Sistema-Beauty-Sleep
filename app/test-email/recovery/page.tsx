...
import { Mail, Send, CheckCircle, AlertCircle, KeyRound } from 'lucide-react'
  ...
  const handleSendRecovery = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setResult({
        ...
        message: data.message || data.error || 'Erro ao enviar email de recuperação',
      })
    } catch (error: any) {
      setResult({
        success: false,
            ...
            <GlassCard variant="light" blur="lg" className="p-8">
              <GlassCard.Header className="space-y-2 text-center">
                ...
                <GlassCard.Description className="text-white/90">
                  Envie um email de recuperação de senha para um usuário
                ...
                <form onSubmit={handleSendRecovery} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-white/70">
                      O usuário receberá um email com link para redefinir sua senha.
                    </p>
                  </div>
