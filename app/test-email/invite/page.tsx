  ...
  const handleSendInvite = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setResult({
        ...
        message: data.message || data.error || 'Erro ao enviar convite',
      })
    } catch (error: any) {
      setResult({
        success: false,
            ...
            <GlassCard variant="light" blur="lg" className="p-8">
              <GlassCard.Header className="space-y-2 text-center">
                ...
                <GlassCard.Description className="text-white/90">
                  Envie um convite para um novo usuário criar sua conta no Beauty Sleep
                ...
                <form onSubmit={handleSendInvite} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-white/70">
                      O usuário receberá um email com link para criar sua conta e definir sua senha.
                    </p>
                  </div>
