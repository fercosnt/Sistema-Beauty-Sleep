...
-- 1. Criar função wrapper no schema public
...
-- 3. Atualizar o cron job para usar a função wrapper
DO $update_cron$
DECLARE
  job_id BIGINT;
  cmd_text TEXT;
BEGIN
  ...
  IF job_id IS NOT NULL THEN
    -- Construir o comando do cron job (usando variável para evitar conflito de delimitadores)
