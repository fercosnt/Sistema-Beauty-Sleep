...
// Use SVGs from public folder to avoid webpack processing issues
const iconLogo = '/beauty-smile-icon.svg'
const horizontalLogo = '/beauty-smile-horizontal.svg'
const verticalLogo = '/beauty-smile-vertical.svg'
